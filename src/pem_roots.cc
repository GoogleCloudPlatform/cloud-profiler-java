...
// This is the set of certificate authorities from
// https://pki.goog/roots.pem, chosen in order to be able to connect to
// https://googleapis.com and https://sandbox.googleapis.com.
//
// We embed these in the source to avoid having to ship a separate file.
const char *const kPemRootCerts = R"|(
