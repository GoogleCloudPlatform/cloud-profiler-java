...
void HTTPRequest::AddAuthBearerHeader(const string& token) {
...
void HTTPRequest::AddContentTypeHeader(const string& content_type) {
...
bool HTTPRequest::DoPut(const string& url, const string& data) {
...
bool HTTPRequest::DoRequest(const string& url) {
